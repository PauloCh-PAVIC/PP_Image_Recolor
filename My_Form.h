...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// load
			// 
			this->load->Location = System::Drawing::Point(44, 30);
			...
			this->exit->Location = System::Drawing::Point(859, 10);
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(31, 124);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(2);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(469, 508);
			this->pictureBox1->TabIndex = 3;
			this->pictureBox1->TabStop = false;
			// 
			// pictureBox2
			// 
			this->pictureBox2->Location = System::Drawing::Point(524, 123);
			this->pictureBox2->Margin = System::Windows::Forms::Padding(2);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(469, 508);
			this->pictureBox2->TabIndex = 4;
			this->pictureBox2->TabStop = false;
			// 
			// close
			// 
			this->close->Location = System::Drawing::Point(166, 30);
			...
			this->time_exec->Location = System::Drawing::Point(520, 92);
			...
			this->checkBox1->Location = System::Drawing::Point(44, 92);
			...
			// convertToGray
			// 
			this->convertToGray->Location = System::Drawing::Point(277, 30);
			...
			this->convertToGray->Text = L"Converter\n(RGB para Escala de Cinza)";
			...
			// b_teste
			// 
			this->b_teste->Location = System::Drawing::Point(428, 30);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(608, 30);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(696, 30);
			...
			this->ClientSize = System::Drawing::Size(1030, 682);
